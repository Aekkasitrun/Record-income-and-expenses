...
function buildDateFilters(year: number | null, month: number | null) {
  if (!year && !month) return { startDate: undefined as string | undefined, endDate: undefined as string | undefined }
...
function saveFiltersToStorage(data: SavedFilters) {
...
export default function TransactionsPage() {
  ...
  useEffect(() => {
    ...
    fetchCategories()
    fetchSubCategories()
  }, [fetchTransactions, fetchCategories, fetchSubCategories, setFilters])
  ...
  const applyDateFilter = (year: number | null, month: number | null) => {
    const dateFilters = buildDateFilters(year, month)
    setFilters({ ...dateFilters, page: 1 })
    fetchTransactions({ ...dateFilters, page: 1 })
  }
